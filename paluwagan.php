	...
	<div class="bg0 m-t-23 p-b-140">
		<div class="container">
			...
			<div class="row isotope-grid">
				<?php 
					$qrydisplaymenu=mysqli_query($conn,"SELECT * FROM paluwagan WHERE status = 1");
					...
					<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item">
						...
						<div class="block2">
							<div class="block2-pic hov-img0">
								...
								<a href="paluwagan-detail.php?aid=<?= $detail['paluwagan_ID']; ?>" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04">
									View to Join
								</a>
							</div>
							...
							<div class="block2-txt flex-w flex-t p-t-14">
								<div class="block2-txt-child1 flex-col-l ">
									<a href="paluwagan-detail.php?aid=<?= $detail['paluwagan_ID']; ?>" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
										<?= $detail['paluwagan']; ?>
									</a>

									<span class="stext-105 cl3">
										&#8369;<?= number_format($detail['price'],2); ?> for <?= $detail['number_members']; ?> months
									</span>
								</div>
							</div>
						</div>
