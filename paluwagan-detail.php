	...
	<section class="sec-paluwagan-detail bg0 p-t-65 p-b-60">
						...
						<form action="paluwagan-detail_main_exe.php" method="POST">
							...
							<div class="p-t-33">
								...
								<label for="">Date of pickup</label>
									<input class="form-control" type="date" name="date_pickup" required />
								</div>

								<button class="flex-c-m stext-103 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04" name="submit">
									Join Paluwagan
								</button>
							</div>
						</form>
		...
		<div class="bg6 flex-c-m flex-w size-302 m-t-73 p-tb-15">
			<span class="stext-107 cl6 p-lr-25">
				Paluwagan ID: <?= $query['paluwagan_ID']?>
			</span>
		</div>
	</section>
		...
		<div class="container">
			...
			<div class="wrap-slick2">
				<div class="slick2">
					<?php
						$a=$query['paluwagan'];
						$qrydisplaymenu=mysqli_query($conn,"SELECT * FROM paluwagan WHERE paluwagan LIKE '%$a%'");
					...
					<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
						...
						<div class="block2">
							<div class="block2-pic hov-img0">
								...
								<a href="paluwagan-detail.php?aid=<?php echo $detail['paluwagan_ID']; ?>" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04">
									View to Join
								</a>
							</div>
							...
							<div class="block2-txt flex-w flex-t p-t-14">
								<div class="block2-txt-child1 flex-col-l ">
									<a href="paluwagan-detail.php?aid=<?php echo $detail['paluwagan_ID']; ?>" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
										<?= $detail['paluwagan']?>
									</a>

									<span class="stext-105 cl3">
										&#8369;<?= number_format($detail['price'], 2); ?>/month
									</span>
								</div>
							</div>
						</div>
