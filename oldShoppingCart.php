			...
			<div class="wrap-menu-desktop how-shadow1">
				<nav class="limiter-menu-desktop container">
					...
					<div class="wrap-icon-header flex-w flex-r-m">
						...
						<a href="logout.php" class="flex-c-m stext-103 cl0 size-104 bor1 p-lr-15 trans-04">
							Logout
						</a>
					</div>
				</nav>
			...
			<div class="header-cart-content flex-w js-pscroll">
				...
				<div class="w-full">
					...
					<div class="header-cart-buttons flex-w w-full">
						<a href="check_my_cart.php" class="flex-c-m stext-103 cl0 size-107 bg3 bor2 hov-btn3 p-lr-15 trans-04 m-r-8 m-b-10">
							View Cart
						</a>

						<a href="check_my_cart.php" class="flex-c-m stext-103 cl0 size-107 bg3 bor2 hov-btn3 p-lr-15 trans-04 m-b-10">
							Check Out
						</a>
					</div>
				</div>
					...
					<div class="m-l-25 m-r--38 m-lr-0-xl">
						<form action="update_qty.php" method="POST">
										...
										<?php
											...
											if($code=='XX'){
												...
												echo '<div class="checkout-btn">
														<a href="maindex.php?#menu" class="main-button-icon">Go Order Now</a>
													</div>';
												$xb=0;
											}else{
												$xb=0;
										...
										<tr class="table_row">
											...
											<!-- <input type="hidden" value="<?php echo $row['id']; ?>" class="prod_id" name="prod_id"> -->
												<div class="wrap-num-product flex-w m-l-auto m-r-0">
													...
													<input type="number" class="mtext-104 cl3 txt-center num-product" value="<?php echo $row['qty']; ?>" 
													onkeypress="return restrictAlphabets(event)" name="quantity">
											...
											<td class="column-5" id="sTotal" name="sTotal">&#8369;<?php echo $sub_total = number_format($row['price'] * $row['qty'],2); ?></td>
										</tr>
										<?php 
							...
							<div class="flex-w flex-sb-m bor15 p-t-18 p-b-15 p-lr-40 p-lr-15-sm">
								...
								<button type="submit" class="flex-c-m stext-103 cl2 size-119 bg8 bor13 hov-btn3 p-lr-15 trans-04 pointer m-tb-10" name="update_cart">
									Update Cart
								</button>
								<!-- <div class="flex-c-m stext-103 cl2 size-119 bg8 bor13 hov-btn3 p-lr-15 trans-04 pointer m-tb-10">
									Update Cart
								</div> -->
							</div>
						</form>
							...
							<div class="size-209 p-r-18 p-r-0-sm w-full-ssm">							
								<!-- <div class="p-t-15"> -->
									<div class="rs1-select2 rs2-select2 bor8 bg0 m-b-12 m-t-9">
										<select class="js-select2" name="province" id="province-list" onChange="getMunicipality(this.value)" required>
									...
									<div class="rs1-select2 rs2-select2 bor8 bg0 m-b-12 m-t-9">
										<select class="js-select2" name="municipality" id="municipality-list" onchange="getBarangay(this.value)" required> 
									...
									<div class="rs1-select2 rs2-select2 bor8 bg0 m-b-12 m-t-9">
										<select class="js-select2" name="barangay" id="barangay-list" required>
											<option>Select a barangay</option>
										</select>
										<div class="dropDownSelect2"></div>
									</div>

									<div class="bor8 bg0 m-b-11">
										<input class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" id="postcode" name="postcode" placeholder="Postcode / Zip">
									</div>

									<div class="bor8 bg0 m-b-22">
										<input class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" id="postcode" name="sitio" placeholder="Sitio / Purok">
									</div>
									
									<div class="flex-w">
										<div class="flex-c-m stext-103 cl2 size-115 bg8 bor13 hov-btn3 p-lr-15 trans-04 pointer">
											Update Address
										</div>
									</div>
